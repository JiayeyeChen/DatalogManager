        ...
        if (myMFEC_USB.ifNewMessage)
        {
            if (ifDatalogStarted)
            {
                ...
                else
                {
                     ...
                     fileStream << hAKMotorLeftHip.index << "," << hAKMotorLeftHip.systemTime << "," << hAKMotorLeftHip.position << "," << hAKMotorLeftHip.desiredPosition << "," << hAKMotorLeftHip.velocity << "," << hAKMotorLeftHip.current << std::endl;
            ...
            else
            {
                ...
                if (detectStartMsg == "Datalog start")
                {
                    ...
                    fileStream << "Index,Time (ms),Position,Desired Position,Velocity,Iq,Temperature" << std::endl;
